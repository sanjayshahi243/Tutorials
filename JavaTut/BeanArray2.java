...
The array {3, 4, 5, 7} is not a Bean array because of the value 7 
which requires that the array contains either the value 6 (7-1) or 8 (7+1) but neither of these values are in the array.
...
public class BeanArray2 {
    ...
    public static void main(String[] args) {
        System.out.println ("Result: " +isBean(new int[] {1, 1, 1, 2, 1, 1}));
    }
}
